...
$query = "SELECT messages.message, users.username, messages.image_path FROM messages JOIN users ON messages.user_id = users.id ORDER BY messages.created_at DESC";
